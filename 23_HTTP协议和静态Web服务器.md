...
**通信效果图:**![通信效果图](./images/访问web服务器的通信过程.png)
...
**开发者工具的效果图:**![标签说明](./images/通信过程-1.png)
...
**开发者工具使用效果图:**![使用说明](./images/通信过程-2.png)
...
**查看http请求信息效果图:**![查看http请求信息](./images/通信过程-3.png)

![查看http请求信息](./images/通信过程-4.png)

**查看http响应信息效果图:**![查看http请求信息](./images/通信过程-5.png)

![查看http请求信息](./images/通信过程-6.png)
...
**HTTP GET 请求报文效果图:**![GET请求报文分析](./images/get请求报文分析.png)
...
**HTTP POST 请求报文效果图:![GET请求报文分析](./images/post请求报文分析.png)**

**请求体效果图:**![GET请求报文分析](./images/post请求报文分析-1.png)
...
**GET和POST请求对比效果图:**![GGET和POST请求报文对比](./images/get和post请求报文.png)

# 5.HTTP响应报文

### 1. HTTP响应报文分析

**HTTP 响应报文效果图:**![HTTP 响应报文](./images/响应报文-1.png)

![HTTP 响应报文](./images/响应报文-2.png)
...
- 一个HTTP响应报文是由**响应行、响应头、空行和响应体**4个

![HTTP 响应报文](./images/响应报文.png)
...
搭建Python自带的静态Web服务器使用 **python3 -m http.server 端口号**, 效果图如下:![搭建web服务器](./images/搭建web服务器.png)
...
通过浏览器访问搭建的静态Web服务器，效果图如下:![搭建web服务器](./images/搭建web服务器-1674391768482-40.png)

### 4. 查看浏览器和搭建的静态Web服务器的通信过程

查看http的通信过程,效果图如下:![搭建web服务器](./images/静态web服务器的通信过程.png)
...
### 1. 静态Web服务器的问题![问题](./images/静态web服务器问题.png)
