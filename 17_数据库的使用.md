...
**关系型数据库效果图:**![数据库排行榜](./images/关系型数据库.png)
...
**关系型数据库效果图:**![数据库排行榜](./images/数据库排行.png)

### 3. 数据库的作用

数据库的作用就是存储和管理数据的，比如: 我们在京东网站上的浏览的商品列表数据，这些数据都会存储在数据库。

**用户浏览商品列表效果图:**![商品列表](./images/商品列表.png)
...
**关系型数据库管理系统的效果图:**![关系型数据库](./images/数据库关系图.png)
...
**通信流程效果图**![关系型数据库](./images/通信流程-1674392643558-48.png)
...
**显示MySQL服务端安装包信息效果图:![MySQL服务端安装包信息](./images/mysql服务端软件安装包信息.png)**

**查看MySQL服务效果图:**![MySQL服务端安装包信息](./images/mysql服务.png)
...
**查看MySQL配置文件效果图:**![查看mysql配置文件](./images/查看mysql配置文件.png)
...
![Navicat启动效果图](./images/navicat启动.png)

**说明:**

点击两次“取消”按钮, 不需要进行安装。

**试用效果图**![Navicat试用效果图](./images/navicat试用.png)

**启动后效果图**![Navicat试用效果图](./images/navicat首页.png)
...
**显示MySQL客户端安装包信息效果图:**![MySQL客户端安装包信息](./images/mysql客户端软件安装包信息.png)
...
**连接效果图:**![mysql连接操作](./images/mysql连接操作.png)
...
**登录数据库效果图:**![登录数据库](./images/mysql连接操作-1674393146290-65.png)
...
**内连接查询效果图:**![内连接查询](./images/内连接查询.png)
...
**左连接查询效果图:**![内连接查询](./images/左连接查询.png)
...
- 左连接使用left join .. on .., on 表示两个表的连接查询条件
- 左连接以左表为主根据条件查询右表数据，右表数据不存在使用null值填充。![内连接查询](./images/右连接查询.png)
...
**区域表效果图**![区域表](./images/区域表.png)

**例1：查询省的名称为“山西省”的所有城市**![区域表](./images/区域表连表查询分析.png)
...
**如图所示的表结构:![第一范式的问题](./images/1nf.png)**
...
**如图所示的表结构:**![第二范式的问题](./images/2nf.png)
...
**如图所示的表结构:**![第三范式的问题](./images/3nf.png)
...
**E-R模型的效果图:**![E-R模型图](./images/E-R模型图.png)
...
**一对多的关系:**![一对多](./images/1对多.png)

**说明:**

- 1对多关系，在多的一方表(学生表)中创建一个字段，存储班级表的主键值

**多对多的关系:**![一对多](./images/多对多.png)
...
![表的存储引擎](./images/表的存储引擎-1674394272610-81.png) 



​     **说明:**    

1. 常用的表的存储引擎是 InnoDB 和 MyISAM
2. InnoDB 是支持事务的
3. MyISAM 不支持事务，优势是访问速度快，对事务没有要求或者以select、   insert为主的都可以使用该存储引擎来创建表
